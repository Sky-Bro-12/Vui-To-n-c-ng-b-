...
public class Tru2PhanSo : MonoBehaviour
{
    ...
    public void GenerateQuestion()
    {
        ...
        if(rutgonMau < 0) //Chuyển dấu trừ lên trước
        {
            rutgonTu *= -1;
            rutgonMau *= -1;
        }
        ...
        {
            int wrongTu1 = Random.Range(1, 100);
            ...
            int rutgonWrongTu = wrongTu / wrongGCD;
            int rutgonWrongMau = wrongMau / wrongGCD;

            if (rutgonWrongMau < 0) //Chuyển dấu trừ lên phía trước
            {
                rutgonWrongTu *= -1;
                rutgonWrongMau *= -1;
            }

            string wrongAns = $"{rutgonWrongTu}/{rutgonWrongMau}";
