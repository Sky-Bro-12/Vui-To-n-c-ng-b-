...
public class LuyThua1ChuSo : MonoBehaviour
{
    ...
    {
        // Tạo lũy thừa ngẫu nhiên
        int a = Random.Range(0, 10);
        int b = Random.Range(0, 9);
        correctAnswer = (int)Mathf.Pow(a, b);
        ...
        {
            int wrongAnswer = Random.Range(correctAnswer - 1000, correctAnswer + 1000);
