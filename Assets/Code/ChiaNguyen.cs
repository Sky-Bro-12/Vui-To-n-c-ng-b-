...
public class ChiaNguyen : MonoBehaviour
{
    ...
    public void GenerateQuestion()
    {
        ...
        int multiplier = Random.Range(0, 10); // tạo kết quả trong khoảng 0 - 10
        int a = b * multiplier;
        correctAnswer = a / b;
        ...
        while (options.Count < 4)
        {
            ...
            if (wrongAnswer >= 0 && wrongAnswer != correctAnswer) options.Add(wrongAnswer);
        }
